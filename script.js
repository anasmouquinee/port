...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "bash",
    "codeSnippet": "# Start the entire distributed data infrastructure\n# (Kafka, Airflow, MinIO, PostgreSQL, Superset, Prometheus, Grafana)\ndocker-compose up -d\n\n# Access Apache Airflow for pipeline orchestration\necho \"Airflow: http://localhost:8080\"",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Airflow",
    ...
    "desc": "This project delivers a comprehensive enterprise lakehouse and real-time media intelligence platform, designed to ingest, process, and visualize data from news articles. It leverages a distributed architecture with a Medallion Lakehouse pattern and robust ETL/ELT pipelines to provide actionable insights.",
    "features": [
      "End-to-end distributed data ingestion, processing, and visualization pipeline for news articles.",
      "Implemented a Medallion Lakehouse architecture for scalable and organized data storage (Bronze, Silver, Gold layers).",
      "Real-time media intelligence platform with integrated monitoring (Prometheus, Grafana) and analytics (Apache Superset).",
      "Containerized deployment and orchestration using Docker Compose and Kubernetes for resilient and scalable infrastructure."
    ],
  ...
  },
  {
    ...
    "desc": "Developed a robust full-stack foundation for AI-powered web applications, integrating modern frontend practices with scalable backend capabilities. This project emphasizes performance, developer experience, and code quality through advanced tooling and containerization.",
    "features": [
      "Next-gen Frontend Architecture with React, TypeScript, and Vite for optimal development experience.",
      "Robust Code Quality Enforcement via Oxlint, ensuring high standards with type-aware linting.",
      "Containerized Deployment Workflow utilizing Docker for consistent and scalable application environments.",
      "Foundational API Design for future AI/ML integrations, supporting modular backend development."
    ],
