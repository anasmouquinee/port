...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import json\n\ndef transform_article_for_warehouse(raw_payload: str) -> dict:\n    \"\"\"\n    Transforms a raw news article JSON payload into a structured format\n    suitable for a data warehouse, standardizing fields and extracting key info.\n    \"\"\"\n    article = json.loads(raw_payload)\n    return {\n        \"article_id\": article.get(\"id\"),\n        \"title_cleaned\": article.get(\"title\", \"\").strip(),\n        \"source_name\": article.get(\"source\", {}).get(\"name\"),\n        \"publish_date\": article.get(\"publishedAt\").split(\"T\")[0] if article.get(\"publishedAt\") else None,\n        \"content_hash\": hash(article.get(\"content\", \"\"))\n    }",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project establishes a comprehensive, distributed enterprise lakehouse platform designed for real-time media intelligence. It orchestrates the ingestion, processing, and visualization of news article data, leveraging a medallion architecture for scalable ETL/ELT.",
    "features": [
      "Real-time news article scraping and ingestion pipeline via Apache Kafka.",
      "Robust Enterprise Lakehouse architecture (Data Lake & Data Warehouse) with MinIO and PostgreSQL.",
      "Automated ETL/ELT workflows orchestrated by Apache Airflow following a Medallion Architecture.",
      "Interactive media intelligence dashboards and monitoring with Apache Superset, Prometheus, and Grafana."
    ],
