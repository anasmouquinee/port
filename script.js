...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from datetime import datetime\n\ndef transform_article_data(raw_data: dict) -> dict:\n    \"\"\"\n    Transforms raw article data by cleaning text and extracting key entities.\n    \"\"\"\n    article_id = raw_data.get(\"id\")\n    title = raw_data.get(\"title\", \"\").strip()\n    content = raw_data.get(\"content\", \"\").replace('\\n', ' ').strip()\n    # Placeholder for an NLP function\n    sentiment = \"positive\" # analyze_sentiment(content)\n\n    return {\n        \"article_id\": article_id,\n        \"processed_title\": title,\n        \"summary_text\": content[:200] + \"...\",\n        \"sentiment_score\": sentiment,\n        \"processing_timestamp\": datetime.now().isoformat()\n    }",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project develops a comprehensive, distributed enterprise lakehouse for real-time media intelligence, integrating data ingestion, processing, and visualization from news articles. It leverages a Medallion Architecture with robust ETL/ELT pipelines to provide actionable insights from diverse news sources through a scalable data platform.",
    "features": [
      "Implemented a distributed enterprise lakehouse leveraging a Medallion Architecture for scalable data ingestion and processing.",
      "Orchestrated real-time ETL/ELT pipelines using Apache Airflow and Kafka for continuous media intelligence delivery.",
      "Designed and deployed a containerized infrastructure with Docker and Kubernetes for high availability and scalability.",
      "Integrated comprehensive data visualization (Superset) and monitoring (Prometheus, Grafana) for operational insights."
    ],
  ...
  },
  {
    ...
    "desc": "This repository establishes a modern, type-safe frontend foundation for the Omnipulse AI Studio using React, TypeScript, and Vite. It emphasizes developer experience and code quality through fast hot module reloading and robust Oxlint configurations, laying the groundwork for interactive AI applications.",
    "features": [
      "High-Performance Frontend Development: Leverages Vite for lightning-fast development, hot module replacement (HMR), and optimized build processes.",
      "Robust Type Safety: Implements TypeScript throughout the codebase to ensure type consistency, reduce bugs, and enhance maintainability.",
      "Automated Code Quality: Utilizes Oxlint for strict linting rules, enforcing coding standards and identifying potential issues early in development.",
      "Containerized Development Environment: Provides a Dockerfile for consistent, isolated development and deployment environments."
    ],
