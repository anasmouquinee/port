...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import json\nfrom datetime import datetime\n\ndef transform_raw_to_silver(raw_data: dict) -> dict:\n    \"\"\"\n    Transforms raw news data (Bronze layer) to a refined format (Silver layer).\n    \"\"\"\n    article = {\n        \"title\": raw_data.get(\"title\", \"\").strip(),\n        \"body_summary\": raw_data.get(\"body\", \"\")[:200].replace(\"\\n\", \" \").strip(),\n        \"source_domain\": raw_data.get(\"url\", \"\").split('/')[2] if raw_data.get(\"url\") else None,\n        \"ingestion_timestamp\": raw_data.get(\"ingestion_ts\"),\n        \"processing_timestamp\": datetime.utcnow().isoformat() + \"Z\"\n    }\n    return article",
    "img": null,
    "gallery": [],
    "tech": [
      "Python",
    ...
    "desc": "This project delivers a comprehensive, distributed platform for ingesting, processing, and visualizing real-time news article data, addressing the need for scalable media intelligence. It achieves this by implementing a robust Enterprise Lakehouse with a Medallion Architecture, ensuring data quality and enabling powerful analytics.",
    "features": [
      "Implemented a scalable Enterprise Lakehouse architecture for comprehensive media data management.",
      "Developed real-time media intelligence capabilities with distributed ingestion and processing pipelines.",
      "Enforced data quality and governance through a Medallion Architecture (Bronze, Silver, Gold layers).",
      "Integrated full-stack observability and analytics using Apache Superset, Prometheus, and Grafana."
    ],
  ...
  },
  {
    ...
    "desc": "Omnipulse AI Studio is a full-stack web application designed for building and managing AI-powered tools, leveraging a modern React and TypeScript frontend. It integrates robust API services and data management capabilities, enabling rapid development and deployment of intelligent systems.",
    "features": [
      "Modern frontend architecture with React, TypeScript, and Vite for optimal performance.",
      "Robust backend API integration facilitating complex AI model interactions.",
      "Containerized deployment using Docker for consistent multi-environment operation.",
      "Integrated AI prompting and testing capabilities for rapid development of intelligent agents."
    ],
