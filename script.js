...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import json\nfrom datetime import datetime\n\ndef process_raw_article(raw_data: str) -> dict:\n    \"\"\"Transforms raw JSON article data into a structured format for the bronze layer.\"\"\"\n    article = json.loads(raw_data)\n    processed_article = {\n        \"id\": article.get(\"id\"),\n        \"title\": article.get(\"title\"),\n        \"content_hash\": hash(article.get(\"content\", \"\")), # Simple content hash\n        \"source\": article.get(\"source\"),\n        \"processed_timestamp\": datetime.now().isoformat()\n    }\n    return processed_article",
    "img": null,
    "gallery": [],
    "tech": [
      "Python",
    ...
    "desc": "Developed a comprehensive, distributed platform for real-time media intelligence, integrating data ingestion, processing, and visualization from news articles. It leverages a modern lakehouse architecture to provide scalable data management and analytics capabilities.",
    "features": [
      "Implemented a distributed Lakehouse architecture for scalable ingestion and processing of news data.",
      "Orchestrated complex ETL/ELT pipelines using Apache Airflow for data flow automation.",
      "Integrated real-time streaming with Apache Kafka for dynamic media intelligence updates.",
      "Enabled comprehensive monitoring and visualization through Prometheus, Grafana, and Apache Superset."
    ],
  ...
  },
  {
    ...
    "codeSnippet": "import axios from 'axios';\n\ninterface PromptResponse {\n  generatedText: string;\n}\n\nexport async function submitAIPrompt(prompt: string, model: string): Promise<PromptResponse> {\n  try {\n    const response = await axios.post<PromptResponse>('/api/ai/generate', { prompt, model });\n    return response.data;\n  } catch (error) {\n    console.error('Error submitting AI prompt:', error);\n    throw new Error('Failed to get AI generation.');\n  }\n}",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "This project delivers a sophisticated AI studio platform, featuring a high-performance React and TypeScript frontend built with Vite and Oxlint for exceptional developer experience. It facilitates seamless interaction with underlying AI services through a robust API, enabling users to create and manage AI-driven content and workflows.",
    "features": [
      "High-performance, type-safe frontend with React, TypeScript, and Vite",
      "Robust API for integrating and managing AI services",
      "Enhanced code quality and developer experience via Oxlint linting rules",
      "Containerized deployment strategy using Docker for consistency"
    ],
