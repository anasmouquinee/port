...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import pandas as pd\nfrom datetime import datetime\n\ndef clean_and_enrich_news(df_raw: pd.DataFrame) -> pd.DataFrame:\n    \"\"\"Cleans text, extracts entities, and enriches news data.\"\"\"\n    df_processed = df_raw.copy()\n    df_processed['headline'] = df_processed['title'].str.upper()\n    df_processed['processed_date'] = datetime.now().isoformat()\n    df_processed['sentiment'] = df_processed['content'].apply(\n        lambda x: 'positive' if 'breakthrough' in x.lower() else 'neutral'\n    )\n    return df_processed",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project implements a comprehensive, distributed enterprise lakehouse for real-time media intelligence, ingesting, processing, and visualizing news articles. It leverages a modern data stack to build an end-to-end platform for data scraping, storage, and analytics, demonstrating robust data engineering principles.",
    "features": [
      "Real-Time Data Ingestion and Processing from News Sources via Apache Kafka",
      "Scalable Enterprise Lakehouse Architecture leveraging MinIO and Medallion Layers",
      "Automated Data Orchestration & ETL/ELT Pipelines with Apache Airflow",
      "Integrated Business Intelligence & Real-Time Monitoring with Superset, Grafana, and Prometheus"
    ],
