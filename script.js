...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow.operators.python import PythonOperator\n\ndef _process_raw_data(source: str):\n    \"\"\"Placeholder for transforming raw ingested data into refined zone.\"\"\"\n    print(f\"Starting processing for raw data from: {source}...\")\n    # Logic to fetch raw data from MinIO, transform, and store in curated zone\n    # e.g., raw_data = MinIODatabase().get_raw_data(source)\n    #       processed_data = DataProcessor.clean_and_enrich(raw_data)\n    #       MinIODatabase().save_curated_data(processed_data)\n    print(f\"Finished processing raw data for: {source}.\")\n\nprocess_task = PythonOperator(\n    task_id='process_news_articles',\n    python_callable=_process_raw_data,\n    op_kwargs={'source': 'news_articles'},\n)",
    "img": null,
    "gallery": [],
    "tech": [
      "Python",
    ...
    "desc": "This project implements a comprehensive and distributed enterprise lakehouse platform for real-time media intelligence, designed for ingestion, processing, and visualization of news article data. It leverages a modern data architecture to provide scalable data analytics and actionable insights from various media sources.",
    "features": [
      "Implemented a distributed enterprise lakehouse architecture with Medallion zones for scalable data management.",
      "Developed real-time media intelligence platform with dynamic news article scraping and processing capabilities.",
      "Orchestrated complex ETL/ELT pipelines using Apache Airflow for automated data workflows and governance.",
      "Integrated comprehensive data visualization (Apache Superset) and monitoring (Prometheus/Grafana) for operational insights."
    ],
