...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from datetime import datetime\n\ndef transform_news_to_silver(raw_news_data: dict) -> dict:\n    \"\"\"\n    Processes raw news articles into a structured 'Silver' layer format.\n    Applies basic cleansing and enrichment for analytical readiness.\n    \"\"\"\n    news_id = raw_news_data.get(\"id\")\n    title = raw_news_data.get(\"title\", \"No Title\")\n    content = raw_news_data.get(\"content\", \"\")\n\n    processed_entry = {\n        \"article_id\": news_id,\n        \"headline\": title.strip(),\n        \"summary\": content[:200].strip() + (\"...\" if len(content) > 200 else \"\"),\n        \"processed_timestamp\": datetime.now().isoformat(),\n        \"source_system\": \"Global-NewsStream\"\n    }\n    return processed_entry",
    "img": null,
    "gallery": [],
    "tech": [
      "Python",
    ...
    "desc": "This project delivers a distributed enterprise lakehouse and real-time media intelligence platform, enabling comprehensive ingestion, processing, and visualization of news data. It leverages a robust medallion architecture and advanced ETL/ELT pipelines to provide actionable insights from large-scale media streams.",
    "features": [
      "Real-time enterprise lakehouse for comprehensive media intelligence",
      "Medallion architecture (Bronze, Silver, Gold layers) for robust data quality and governance",
      "Distributed data processing & orchestration with Apache Kafka and Apache Airflow",
      "Containerized deployment via Docker and scalable orchestration with Kubernetes"
    ],
