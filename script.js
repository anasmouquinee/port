...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom airflow.utils.dates import days_ago\n\nwith DAG(\n    dag_id='news_stream_ingestion_dag',\n    start_date=days_ago(1),\n    schedule_interval='@daily',\n    catchup=False,\n    tags=['news', 'data_lakehouse'],\n) as dag:\n    ingest_articles = BashOperator(\n        task_id='start_scraper_ingestion',\n        bash_command='python /app/scrapers/run_scraper.py',\n    )\n    process_raw_to_bronze = BashOperator(\n        task_id='process_raw_data_to_bronze',\n        bash_command='python /app/pipelines/raw_to_bronze.py',\n    )\n    ingest_articles >> process_raw_to_bronze",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project develops a comprehensive, distributed platform for real-time ingestion, processing, and visualization of news articles. It establishes an enterprise-grade data lakehouse with a medallion architecture, enabling scalable media intelligence and analytics.",
    "features": [
      "Real-time news article ingestion and stream processing using Apache Kafka.",
      "Distributed enterprise data lakehouse with MinIO and Medallion Architecture.",
      "Automated ETL/ELT pipelines orchestrated by Apache Airflow.",
      "Integrated real-time analytics and monitoring with Apache Superset and Grafana."
    ],
