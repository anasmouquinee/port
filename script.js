...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom datetime import datetime\n\nwith DAG(\n    dag_id='newsstream_data_processing',\n    start_date=datetime(2023, 1, 1),\n    schedule_interval='@daily',\n    catchup=False,\n) as dag:\n    transform_task = BashOperator(\n        task_id='transform_bronze_to_silver',\n        bash_command='spark-submit /opt/airflow/pipelines/bronze_to_silver.py',\n    )",
    "img": null,
    "gallery": [],
    "tech": [
      "Python",
    ...
    "desc": "This project is a comprehensive, distributed platform for ingesting, processing, and visualizing news article data, leveraging a modern data lakehouse architecture. It achieves real-time media intelligence through scalable data pipelines, robust storage, and advanced analytical tools.",
    "features": [
      "Real-time data ingestion and stream processing with Apache Kafka for immediate media intelligence.",
      "Scalable Lakehouse Architecture implementing a Medallion data model with MinIO and PostgreSQL.",
      "Automated ETL/ELT pipelines orchestrated by Apache Airflow for robust data transformation.",
      "Integrated monitoring and business intelligence via Prometheus, Grafana, and Apache Superset."
    ],
  ...
  },
  {
    ...
    "codeSnippet": "interface AIPromptRequest {\n  prompt: string;\n  parameters?: Record<string, any>;\n}\n\nasync function submitAIPrompt(request: AIPromptRequest): Promise<string> {\n  const res = await fetch('/api/ai/generate', {\n    method: 'POST',\n    headers: { 'Content-Type': 'application/json' },\n    body: JSON.stringify(request),\n  });\n  if (!res.ok) throw new Error('AI service failed');\n  const data = await res.json();\n  return data.response; // Assuming 'response' field contains AI output\n}",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "Engineered a full-stack AI studio platform enabling interactive development and deployment of AI-driven applications. Leveraged a modern React/Vite/TypeScript frontend with a robust backend, integrating advanced linting and containerization for scalable, high-quality development.",
    "features": [
      "Interactive User Interface with React and Vite for a highly responsive development experience",
      "Enhanced Code Quality and Type Safety through comprehensive TypeScript integration across the codebase",
      "Integrated API for seamless interaction with AI models and prompt engineering capabilities",
      "Streamlined Deployment Workflow utilizing Docker for containerization and Vercel for continuous integration",
      "Robust Development Environment with Oxlint for static analysis and performance optimization"
    ],
