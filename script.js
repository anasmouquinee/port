...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "desc": "This project delivers a comprehensive, real-time media intelligence platform for ingesting, processing, and visualizing data from news articles. It establishes a distributed enterprise Lakehouse architecture leveraging robust ETL/ELT pipelines, data warehousing, and advanced monitoring for scalable media analytics.",
    "features": [
      "Distributed Enterprise Lakehouse Architecture for unified data management.",
      "Real-time Data Ingestion & Processing with Apache Kafka for immediate media intelligence.",
      "Automated ETL/ELT Pipelines orchestrated by Apache Airflow for robust data transformation.",
      "Dynamic Media Intelligence Dashboards with Apache Superset and full infrastructure monitoring."
    ],
  ...
  },
  {
    ...
    "codeSnippet": "export const generateAIOutput = async (inputPrompt: string): Promise<string> => {\n  const response = await fetch('/api/ai/generate', {\n    method: 'POST',\n    headers: { 'Content-Type': 'application/json' },\n    body: JSON.stringify({ prompt: inputPrompt }),\n  });\n  if (!response.ok) {\n    const errorData = await response.json();\n    throw new Error(errorData.message || 'Failed to generate AI output.');\n  }\n  const data = await response.json();\n  return data.generatedText;\n};",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "OmniPulse AI Studio is a full-stack web application designed to provide a comprehensive environment for interacting with or developing AI-driven solutions. It leverages modern frontend technologies like React and TypeScript, integrated with a robust backend, to deliver a performant and scalable platform for AI experimentation and deployment.",
    "features": [
      "Component-driven UI built with React and TypeScript for robust, maintainable user experiences.",
      "Backend API for managing AI model interactions and data processing.",
      "Containerized deployment using Docker and Vercel for scalable and portable environments.",
      "Optimized development workflow with Vite and Oxlint for enhanced performance and code quality."
    ],
