...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import pandas as pd\nfrom minio import Minio\n\ndef process_raw_article_data(bucket_name, object_name):\n    client = Minio(\"minio:9000\", access_key=\"minio_admin\", secret_key=\"anaskaelar\")\n    response = client.get_object(bucket_name, object_name)\n    df = pd.read_parquet(response.read()) # Assuming raw data is parquet\n    df_clean = df.drop_duplicates(subset=['title', 'url'])\n    df_enriched = df_clean[df_clean['text'].str.len() > 50]\n    return df_enriched.to_parquet()",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This platform establishes an enterprise-grade lakehouse architecture for real-time media intelligence, integrating robust data ingestion, processing, and visualization capabilities. It leverages a distributed stack to efficiently transform raw news articles into actionable insights, supporting scalable ETL/ELT operations and comprehensive monitoring.",
    "features": [
      "Enterprise Lakehouse Architecture (Medallion) for structured and scalable data management.",
      "Real-time data ingestion and processing using web scrapers and Apache Kafka.",
      "Distributed workflow orchestration of complex ETL/ELT pipelines with Apache Airflow.",
      "Integrated monitoring (Prometheus/Grafana) and dynamic business intelligence with Apache Superset."
    ],
