...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.python import PythonOperator\nfrom datetime import datetime\n\ndef process_news_article():\n    # Simulates fetching, cleaning, and initial storage of a news article.\n    print(\"Fetching and processing a news article...\")\n\nwith DAG('news_article_pipeline', start_date=datetime(2023, 1, 1), schedule_interval='@hourly') as dag:\n    process_task = PythonOperator(\n        task_id='process_single_article',\n        python_callable=process_news_article,\n    )",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project delivers a comprehensive, distributed platform for real-time ingestion, processing, and visualization of news articles using a modern lakehouse architecture. It establishes robust ETL/ELT pipelines to transform raw data into actionable media intelligence, enabling scalable data analytics and reporting.",
    "features": [
      "Implemented a scalable enterprise lakehouse architecture for real-time media intelligence from news articles.",
      "Designed and orchestrated robust ETL/ELT pipelines using Apache Airflow for data ingestion, processing, and warehousing.",
      "Leveraged Apache Kafka for high-throughput real-time data streaming and MinIO as a flexible data lake.",
      "Provided comprehensive monitoring with Prometheus/Grafana and dynamic data visualization via Apache Superset."
    ],
  ...
  },
  {
    ...
    "desc": "Omnipulse AI Studio is a robust web application designed for interacting with and managing AI services. Built with React, TypeScript, and Vite, it integrates advanced frontend tooling and leverages a structured API for backend interactions.",
    "features": [
      "Scalable AI service integration via a structured API.",
      "Modern, performant frontend built with React, TypeScript, and Vite.",
      "Containerized deployment ready with Docker for environmental consistency.",
