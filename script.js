...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom datetime import datetime\n\nwith DAG(dag_id='data_lakehouse_pipeline_orchestration', start_date=datetime(2023, 1, 1)) as dag:\n    ingest_bronze = BashOperator(task_id='ingest_to_bronze', bash_command='run_ingestion_script.sh')\n    transform_silver = BashOperator(task_id='transform_to_silver', bash_command='run_transform_script.sh')\n    load_gold = BashOperator(task_id='load_to_gold', bash_command='run_gold_load_script.sh')\n    \n    ingest_bronze >> transform_silver >> load_gold # Core Medallion Architecture flow",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project delivers a comprehensive, distributed enterprise lakehouse and real-time media intelligence platform for ingesting, processing, and visualizing news data. It achieves this through a robust medallion architecture, leveraging real-time streaming, batch ETL/ELT, and advanced observability for powerful insights.",
    "features": [
      "Implemented an Enterprise Lakehouse architecture with a Medallion data strategy for structured and unstructured news data.",
      "Designed and orchestrated real-time data ingestion pipelines using Apache Kafka and Airflow for high-throughput media intelligence.",
      "Deployed a scalable, distributed infrastructure with Docker and Kubernetes, ensuring robustness and ease of management.",
      "Integrated comprehensive observability solutions, including Prometheus and Grafana, for real-time monitoring of data pipelines and system health."
    ],
  ...
  },
  {
    ...
    "codeSnippet": "interface AIResponse { text: string; confidence: number; }\n\nexport async function getAiPrediction(query: string, model: string): Promise<AIResponse> {\n  const res = await fetch(`/api/models/${model}/predict`, {\n    method: 'POST',\n    headers: { 'Content-Type': 'application/json' },\n    body: JSON.stringify({ query }),\n  });\n  if (!res.ok) throw new Error(`API error: ${res.statusText}`);\n  const data: AIResponse = await res.json();\n  return data;\n}",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "Omnipulse AI Studio provides a robust platform for developing and managing AI applications, leveraging a cutting-edge React and TypeScript frontend. This project demonstrates sophisticated web engineering practices, integrating an API layer for powerful AI model interaction and ensuring high code quality with Oxlint.",
    "features": [
      "Modular React-TypeScript architecture powered by Vite for rapid development and a highly responsive user experience.",
      "Integrated API layer designed for seamless interaction with AI models and backend services.",
      "Enhanced code quality and maintainability enforced through comprehensive Oxlint static analysis rules.",
      "Containerized development and deployment workflow utilizing Docker for environment consistency and scalability."
    ],
