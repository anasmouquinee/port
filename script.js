...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom datetime import datetime\n\nwith DAG(\n    dag_id='news_pipeline',\n    start_date=datetime(2023, 1, 1),\n    schedule_interval='@daily',\n    catchup=False\n) as dag:\n    scrape = BashOperator(task_id='scrape_task', bash_command='python scrapers/run.py')\n    ingest_minio = BashOperator(task_id='ingest_minio_task', bash_command='python ingestion/load.py')\n    transform_data = BashOperator(task_id='transform_task', bash_command='python pipelines/transform.py')\n\n    scrape >> ingest_minio >> transform_data",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Airflow",
    ...
    "desc": "This project is a comprehensive and distributed platform for real-time media intelligence, designed to ingest, process, and visualize news article data. It leverages a modern enterprise lakehouse architecture, real-time streaming, and robust ETL/ELT pipelines to deliver actionable insights.",
    "features": [
      "Scalable Enterprise Lakehouse Architecture (MinIO, PostgreSQL)",
      "Real-time Data Ingestion & Streaming with Kafka and custom scrapers",
      "Automated ETL/ELT Pipelines and Workflow Orchestration with Apache Airflow",
      "Distributed Deployment & Containerization using Kubernetes and Docker Compose",
      "Integrated Business Intelligence & Monitoring (Superset, Prometheus, Grafana)"
    ],
