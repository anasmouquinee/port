...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "desc": "Developed omnipulse-ai-studio, an AI interaction platform designed to provide a modern web interface for engaging with AI models. This project features a robust full-stack architecture leveraging React, TypeScript, and Vite for a high-performance frontend, complemented by a scalable backend API for seamless AI integration.",
    "features": [
      "Interactive AI model interfacing via a dedicated API",
      "High-performance front-end with React, TypeScript, and Vite HMR",
      "Robust code quality enforced by Oxlint and type-aware linting",
      "Containerized deployment strategy for consistency and scalability"
    ],
