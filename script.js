...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import json\n\ndef process_news_entry(raw_entry: str) -> dict:\n    data = json.loads(raw_entry)\n    return {\n        \"article_id\": data.get(\"id\"),\n        \"title_clean\": data.get(\"title\", \"\").strip().lower(),\n        \"source_name\": data.get(\"source\", \"unknown\").capitalize(),\n        \"publish_date\": data.get(\"publishedAt\"),\n        \"main_category\": data.get(\"category\", \"General News\")\n    }\n# Core Python transformation function for an Airflow ETL pipeline.",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project implements a comprehensive, distributed enterprise data platform for real-time media intelligence, designed to ingest, process, and visualize news article data. It leverages a modern lakehouse architecture with ETL/ELT pipelines to deliver actionable insights from a diverse set of media sources.",
    "features": [
      "End-to-end Lakehouse architecture for real-time media intelligence",
      "Orchestrated ETL/ELT pipelines for data ingestion, processing, and transformation",
      "Scalable microservices for event streaming (Kafka), data storage (MinIO), and visualization (Superset)",
      "Distributed infrastructure management via Docker Compose and Kubernetes deployment"
    ],
  ...
  },
  {
    ...
    "desc": "This project delivers a full-stack AI-powered studio, designed to facilitate advanced prompt engineering and data interaction through a modern web interface. It leverages a robust React/TypeScript frontend and a backend API to support intelligent data processing and AI model integration.",
    "features": [
      ...
      "Modern frontend developed with React, TypeScript, and Vite for optimal performance",
      "Advanced linting and type-aware development with Oxlint for code quality"
    ],
