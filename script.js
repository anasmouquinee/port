...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "desc": "This platform delivers real-time media intelligence by ingesting, processing, and visualizing news articles from various sources. It leverages a distributed lakehouse architecture for scalable data management and provides end-to-end data pipelines for actionable insights.",
    "features": [
      "Distributed Lakehouse Architecture for scalable data storage and processing.",
      "Real-time media intelligence pipeline with Kafka for high-throughput data streaming.",
      "Automated ETL/ELT workflows orchestrated by Apache Airflow.",
      "Integrated monitoring with Prometheus/Grafana and data visualization with Apache Superset."
    ],
  ...
  },
  {
    ...
    "desc": "Developed a robust web-based AI studio leveraging modern frontend technologies to provide an intuitive interface for AI model interaction and prompt engineering. This platform streamlines the process of experimenting with AI capabilities, ensuring a responsive and high-performance user experience for complex tasks.",
    "features": [
      "Interactive AI Prompt Management System",
      "Containerized Deployment with Docker",
      "Type-Safe & Performant Frontend Architecture",
      "Scalable API-driven AI Interaction"
    ],
