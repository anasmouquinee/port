...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom airflow.utils.dates import days_ago\n\nwith DAG(\n    dag_id='news_stream_pipeline',\n    start_date=days_ago(1),\n    schedule_interval=None,\n    catchup=False,\n    tags=['news', 'data_lake'],\n) as dag:\n    ingest_raw_data = BashOperator(\n        task_id='ingest_raw_articles',\n        bash_command='python /opt/airflow/dags/ingestion/scraper.py --source news_site',\n    )\n\n    process_bronze_layer = BashOperator(\n        task_id='process_to_bronze',\n        bash_command='spark-submit /opt/airflow/dags/pipelines/bronze_processing.py',\n    )\n\n    transform_silver_layer = BashOperator(\n        task_id='transform_to_silver',\n        bash_command='spark-submit /opt/airflow/dags/pipelines/silver_transformation.py',\n    )\n\n    ingest_raw_data >> process_bronze_layer >> transform_silver_layer",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "This project delivers a robust, distributed platform for real-time media intelligence, enabling automated ingestion, processing, and visualization of news articles. It features a scalable enterprise lakehouse architecture with sophisticated ETL/ELT pipelines and advanced data governance for actionable insights.",
    "features": [
      "Implemented a scalable enterprise lakehouse architecture for unified data storage and advanced analytics.",
      "Developed real-time distributed data ingestion pipelines using Apache Kafka and custom web scrapers.",
      "Orchestrated complex ETL/ELT workflows and data transformations with Apache Airflow.",
      "Deployed a containerized infrastructure on Kubernetes for high availability and elastic scalability."
    ],
  ...
  },
  {
    ...
    "desc": "Omnipulse AI Studio provides a robust web-based development environment for AI applications, leveraging a modern React, TypeScript, and Vite stack for high performance. It integrates advanced tooling like Oxlint for code quality and prepares for React Compiler integration, ensuring an optimized and scalable foundation for AI model interaction and deployment.",
    "features": [
      "Scalable Frontend Architecture with React, TypeScript, and Vite HMR.",
      "Integrated Code Quality and Linting via Oxlint for robust development.",
      "Modular API Gateway for seamless backend service interaction.",
