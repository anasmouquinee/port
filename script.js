...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "def transform_raw_to_silver_layer(raw_data: dict) -> dict:\n    \"\"\"Transforms raw news article data to a refined 'silver' layer format.\"\"\"\n    silver_data = {\n        \"article_id\": raw_data.get(\"id\"),\n        \"title\": raw_data.get(\"title\", \"\").strip(),\n        \"source\": raw_data.get(\"source\", {}).get(\"name\", \"Unknown\"),\n        \"published_at\": raw_data.get(\"published_at\"),\n        \"keywords\": raw_data.get(\"tags\", []),\n        \"content_hash\": hash(raw_data.get(\"content\", \"\"))\n    }\n    return silver_data",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Airflow",
    ...
    "desc": "A comprehensive, distributed platform for real-time media intelligence, designed to ingest, process, and visualize news article data. It leverages an enterprise lakehouse architecture with real-time streaming, ETL/ELT pipelines, and robust data warehousing for advanced media analytics.",
    "features": [
      "Distributed architecture for real-time news article ingestion, processing, and analysis",
      "Enterprise Data Lakehouse with Medallion Architecture (Bronze, Silver, Gold layers)",
      "Automated ETL/ELT pipelines orchestrated by Apache Airflow for data transformation",
      "Scalable, containerized deployment using Docker and Kubernetes with integrated monitoring and visualization"
    ],
