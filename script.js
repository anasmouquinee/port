...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom datetime import datetime\n\nwith DAG(\n    dag_id='news_stream_pipeline',\n    start_date=datetime(2023, 1, 1),\n    schedule_interval='@daily',\n    catchup=False,\n    tags=['news', 'lakehouse', 'elt'],\n) as dag:\n    ingest_raw_data = BashOperator(\n        task_id='ingest_raw_news',\n        bash_command='python /app/scrapers/run_scraper.py',\n    )\n    process_to_bronze = BashOperator(\n        task_id='process_to_bronze_layer',\n        bash_command='spark-submit /app/pipelines/bronze_processor.py',\n    )\n    ingest_raw_data >> process_to_bronze",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Airflow",
    ...
    "desc": "This platform provides a comprehensive, distributed solution for real-time media intelligence by ingesting, processing, and visualizing news article data from various sources. It leverages a robust enterprise lakehouse architecture, implementing ETL/ELT processes and real-time streaming to deliver scalable and insightful media analytics.",
    "features": [
      "Implemented a distributed Enterprise Lakehouse architecture (Medallion Zone) for scalable data storage and processing.",
      "Engineered real-time data ingestion and streaming pipelines using Apache Kafka for high-throughput news article processing.",
      "Orchestrated complex ETL/ELT workflows with Apache Airflow, automating data transformation from raw to curated layers.",
      "Integrated comprehensive monitoring (Prometheus, Grafana) and interactive data visualization (Apache Superset) for media intelligence."
    ],
  ...
  },
  {
    ...
    "codeSnippet": "import OpenAI from 'openai'; // Example AI SDK\n\nconst openai = new OpenAI({ apiKey: process.env.OPENAI_API_KEY });\n\nexport async function processPromptWithAI(prompt: string): Promise<string> {\n  // Processes user prompt using a configured AI model\n  const completion = await openai.chat.completions.create({\n    messages: [{ role: 'user', content: prompt }],\n    model: 'gpt-3.5-turbo', // Configurable AI model\n    temperature: 0.7,\n    max_tokens: 150,\n  });\n  return completion.choices[0].message.content || 'No response generated.';\n}",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "Omnipulse AI Studio is a comprehensive full-stack application designed to provide an interactive platform for AI development and experimentation. It integrates modern web frameworks with robust backend services, enabling scalable AI-driven features and data management.",
    "features": [
      "Full-stack architecture with dedicated API for AI services.",
      "Interactive AI prompt testing and management capabilities.",
