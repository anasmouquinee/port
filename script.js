...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import json\nfrom kafka import KafkaConsumer\nfrom datetime import datetime\n\ndef process_streamed_article(message_value: bytes) -> dict:\n    \"\"\"Decodes and enhances a streamed news article with processing metadata.\"\"\"\n    article_data = json.loads(message_value.decode('utf-8'))\n    return {\n        **article_data,\n        \"processing_timestamp\": datetime.utcnow().isoformat(),\n        \"status\": \"processed\"\n    }\n",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "A comprehensive, distributed platform for real-time media intelligence, designed to ingest, process, and visualize news articles from various sources. It leverages a modern Lakehouse architecture with real-time streaming to provide dynamic insights and robust data management.",
    "features": [
      "Real-time data ingestion and processing pipeline for multi-source news articles.",
      "Distributed Lakehouse architecture for scalable storage and efficient data management.",
      "Automated ETL/ELT workflows orchestrated by Apache Airflow for data transformation and loading.",
      "Integrated analytics and visualization capabilities using Apache Superset, Prometheus, and Grafana."
    ],
  ...
  },
  {
    ...
    "codeSnippet": "async function callAIGeneration(promptText: string): Promise<string> {\n  const response = await fetch('/api/ai/generate', {\n    method: 'POST',\n    headers: { 'Content-Type': 'application/json' },\n    body: JSON.stringify({ prompt: promptText })\n  });\n  if (!response.ok) {\n    throw new Error('AI generation failed');\n  }\n  const data = await response.json();\n  return data.generatedOutput;\n}",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "Omnipulse AI Studio offers a robust web-based platform for developing and interacting with AI models and services. Built with React, TypeScript, and Vite, it integrates modern web development practices with a custom API layer to facilitate advanced AI functionalities.",
    "features": [
      "Modern, type-safe frontend architecture using React, TypeScript, and Vite for a highly interactive user experience.",
      "Dedicated API layer for seamless integration with AI models and data processing workflows.",
      "Robust code quality and maintainability enforced through advanced Oxlint configurations.",
      "Containerized development and streamlined deployment via Docker and Vercel for continuous delivery."
    ],
