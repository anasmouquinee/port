...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom datetime import datetime\n\nwith DAG(\n    dag_id='news_stream_elt',\n    start_date=datetime(2023, 1, 1),\n    schedule_interval='@hourly',\n    catchup=False\n) as dag:\n    # Task to process raw news data into a refined zone\n    process_data = BashOperator(\n        task_id='process_news_articles',\n        bash_command='python /app/pipelines/process_articles.py',\n    )",
    "img": null,
    "gallery": [],
    "tech": [
      "Python",
    ...
    "desc": "This distributed enterprise platform provides end-to-end ingestion, processing, and visualization of news articles, building a real-time media intelligence system. It leverages a robust Lakehouse architecture with orchestrated ETL/ELT pipelines to deliver actionable insights from diverse data sources.",
    "features": [
      "Distributed Enterprise Lakehouse Architecture for unified data management",
      "Real-time Media Intelligence via Kafka-driven ingestion and processing",
      "Orchestrated ETL/ELT Pipelines enforcing Medallion Architecture principles",
      "Dynamic Data Visualization and Reporting with Apache Superset"
    ],
  ...
  },
  {
    ...
    "codeSnippet": "import React from 'react';\n\ninterface AICardProps {\n  title: string;\n  description: string;\n}\n\nconst AICard: React.FC<AICardProps> = ({ title, description }) => (\n  <div className=\"card\">\n    <h3>{title}</h3>\n    <p>{description}</p>\n  </div>\n);\n\nexport default AICard;",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "This project is a robust AI studio frontend, leveraging React, TypeScript, and Vite to deliver a highly performant and maintainable user interface. It features an optimized development environment with HMR, a comprehensive linting setup using Oxlint for code quality, and integrates with backend APIs to power AI functionalities.",
    "features": [
      "High-performance React frontend leveraging Vite for rapid development and Hot Module Replacement (HMR).",
      "Robust code quality enforcement through Oxlint for static analysis and adherence to best practices.",
      "Containerized deployment readiness with Docker, ensuring consistent environments across development and production.",
      "Seamless CI/CD integration and streamlined deployment via Vercel for continuous delivery."
    ],
