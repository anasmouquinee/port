...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "from airflow import DAG\nfrom airflow.operators.bash import BashOperator\nfrom datetime import datetime\n\nwith DAG(\n    dag_id='news_ingestion_pipeline',\n    start_date=datetime(2023, 1, 1),\n    schedule_interval='@daily',\n    catchup=False,\n) as dag:\n    scrape = BashOperator(task_id='scrape_data', bash_command='python /app/scrapers/run.py')\n    process = BashOperator(task_id='process_bronze', bash_command='python /app/pipelines/process.py')\n    load = BashOperator(task_id='load_gold', bash_command='python /app/pipelines/load.py')\n\n    scrape >> process >> load",
    "img": null,
    "gallery": [],
    "tech": [
      "Python",
    ...
    "desc": "This platform delivers a comprehensive, distributed enterprise lakehouse for real-time media intelligence, ingesting and processing news articles from various sources. It achieves end-to-end data lifecycle management, from scraping and streaming to warehousing and visualization, leveraging a robust medallion architecture.",
    "features": [
      "Implements distributed scraping and real-time ingestion of news articles, leveraging Kafka for high-throughput streaming.",
      "Establishes a robust Medallion architecture with MinIO for raw/bronze storage and PostgreSQL for curated/gold data warehousing.",
      "Automates complex ETL/ELT data pipelines using Apache Airflow, ensuring reliable and scheduled data processing.",
      "Provides real-time system monitoring with Prometheus and Grafana, alongside interactive data visualization via Apache Superset."
    ],
  ...
  },
  {
    ...
    "codeSnippet": "async function generateAIPromptResponse(\n  modelId: string,\n  promptText: string,\n  temperature: number = 0.7\n): Promise<string> {\n  try {\n    const response = await fetch(`/api/models/${modelId}/generate`, {\n      method: 'POST',\n      headers: { 'Content-Type': 'application/json' },\n      body: JSON.stringify({ prompt: promptText, temp: temperature })\n    });\n    if (!response.ok) {\n      throw new Error(`API error: ${response.statusText}`);\n    }\n    const data = await response.json();\n    return data.generatedText;\n  } catch (error) {\n    console.error('Failed to generate response:', error);\n    return 'Error: Could not get response.';\n  }\n}",
    "img": null,
    "gallery": [],
    "tech": [
      "React",
    ...
    "desc": "This project delivers a sophisticated web-based studio for developing and interacting with AI applications, leveraging a modern React and TypeScript frontend. It establishes a robust and maintainable development environment through advanced tooling for code quality and efficient compilation.",
    "features": [
      "Interactive AI Development Environment",
      "High-Performance Frontend Stack",
      "Robust Code Quality Assurance",
