...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "desc": "This project delivers a comprehensive, distributed platform for real-time ingestion, processing, and visualization of news article data.\nIt implements a robust enterprise lakehouse architecture, leveraging real-time streaming, ETL/ELT pipelines, and advanced analytics for media intelligence.",
    "features": [
      "Real-time data ingestion and streaming via Apache Kafka.",
      "Automated, scalable ETL/ELT pipeline orchestration using Apache Airflow.",
      "Enterprise Data Lakehouse architecture with Medallion Pattern (MinIO, PostgreSQL).",
      "Containerized deployment and infrastructure management with Docker & Kubernetes.",
      "Integrated media intelligence dashboards and monitoring with Superset, Prometheus & Grafana."
    ],
  ...
  },
  {
    ...
    "desc": "This project is a full-stack AI development studio built with React, TypeScript, and Vite, designed to streamline the creation and testing of AI prompts and models. It features a robust API backend for AI inference and a dynamic frontend for interactive development and deployment.",
    "features": [
      "Interactive AI Prompt Development Environment",
      "Modular API Design for Scalable AI Inference",
      "Type-Safe Frontend Architecture with React & TypeScript",
      "Optimized Full-Stack Development Workflow with Vite & Oxlint"
    ],
