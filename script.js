...
const EMBEDDED_PROJECTS = [
  ...
  },
  {
    ...
    "hasCodeSnippet": true,
    "codeLanguage": "python",
    "codeSnippet": "import pandas as pd\nfrom io import BytesIO\n\ndef process_news_data(raw_bytes: bytes) -> bytes:\n    \"\"\"Loads raw news data, cleans, and converts to a refined format.\"\"\"\n    # Assume raw_bytes is a CSV or JSON payload from Kafka/Data Lake\n    df = pd.read_csv(BytesIO(raw_bytes))\n    \n    # Basic text cleaning and sentiment analysis placeholder\n    df['title'] = df['title'].str.strip().str.lower()\n    df['content'] = df['content'].fillna('').str.lower()\n    \n    # Select and reorder columns for refined zone\n    refined_df = df[['id', 'title', 'content', 'published_date']]\n    return refined_df.to_parquet(index=False)",
    "img": null,
    "gallery": [],
    "tech": [
      "Apache Kafka",
    ...
    "desc": "A comprehensive, distributed platform for real-time media intelligence, designed to ingest, process, and visualize data from news articles. It implements a modern data lakehouse architecture with real-time ingestion, robust ETL/ELT pipelines, and extensive monitoring for advanced analytics and insights.",
    "features": [
      "Implemented a robust Enterprise Lakehouse architecture (Data Lake & Data Warehouse) following the Medallion pattern.",
      "Engineered real-time data ingestion and processing pipelines using Apache Kafka for high-throughput media intelligence.",
      "Orchestrated complex ETL/ELT workflows with Apache Airflow and deployed a distributed infrastructure using Docker and Kubernetes.",
      "Integrated comprehensive monitoring (Prometheus, Grafana) and business intelligence (Apache Superset) for operational visibility and data visualization."
    ],
  ...
  },
  {
    ...
    "desc": "omnipulse-ai-studio provides a robust frontend foundation for an AI studio, leveraging a modern React, TypeScript, and Vite stack. It emphasizes high code quality through Oxlint integration and streamlines deployment with Docker and Vercel.",
    "features": [
      "Leverages a cutting-edge React, TypeScript, and Vite stack for rapid development and optimized performance.",
      "Integrates Oxlint for advanced static code analysis, ensuring high code quality and maintainability.",
      "Utilizes Docker for containerized development and deployment, ensuring environmental consistency.",
      "Configured for seamless continuous deployment via Vercel, enabling agile iteration and delivery."
    ],
